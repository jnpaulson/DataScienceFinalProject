  ...
  fluidPage(
    ...
    sidebarLayout(position="right",
                  sidebarPanel(
                    ...
                    selectInput("xaxis","Select a Hunger Indicator",xaxisNamesUI,xaxisNamesUI[1]),
                    selectInput("yaxis","Select an Outcome Predictive of Hunger",yaxisNamesUI,yaxisNamesUI[1]),
                    uiOutput("ggvis_ui")
                  ),
                  mainPanel(
                    googleAnalytics(),
